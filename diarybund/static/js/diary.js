  ...
  $('#diarybund').prepend(
    `<div id = "${id.pk}--tugas" class = "rounded-lg pl-6 pr-6 py-5 bg-cream-muda shadow-md hover:shadow-xl">
      ...
      <div class="flex justify-between">
        ...
        <div>
          <td><button id="baca" class="text-sm sm:text-md bg-transparent hover:bg-cream-tua font-semibold py-2 px-2 border border-cream-tua hover:border-cream-tua rounded" data-bs-toggle="modal" data-bs-target="#modalBaca--${id.pk}">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
              <path d="M12 15a3 3 0 100-6 3 3 0 000 6z" />
              <path fill-rule="evenodd" d="M1.323 11.447C2.811 6.976 7.028 3.75 12.001 3.75c4.97 0 9.185 3.223 10.675 7.69.12.362.12.752 0 1.113-1.487 4.471-5.705 7.697-10.677 7.697-4.97 0-9.186-3.223-10.675-7.69a1.762 1.762 0 010-1.113zM17.25 12a5.25 5.25 0 11-10.5 0 5.25 5.25 0 0110.5 0z" clip-rule="evenodd" />
            </svg>                      
          </button></td>
          <td><button id="edit" class="text-sm sm:text-md bg-transparent hover:bg-cream-tua font-semibold py-2 px-2 border border-cream-tua hover:border-cream-tua rounded" data-bs-toggle="modal" data-bs-target="#modalUbah--${id.pk}">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
              <path d="M21.731 2.269a2.625 2.625 0 00-3.712 0l-1.157 1.157 3.712 3.712 1.157-1.157a2.625 2.625 0 000-3.712zM19.513 8.199l-3.712-3.712-12.15 12.15a5.25 5.25 0 00-1.32 2.214l-.8 2.685a.75.75 0 00.933.933l2.685-.8a5.25 5.25 0 002.214-1.32L19.513 8.2z" />
            </svg>                      
          </button></td>
          <td><button class="text-sm sm:text-md bg-transparent hover:bg-cream-tua font-semibold py-2 px-2 border border-cream-tua hover:border-cream-tua rounded" onclick="hapusTugas(${id.pk})">
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" class="w-5 h-5">
      ...
      <div class="modal-dialog modal-lg modalCenter">
        <div class="modal-content">
          ...
          <div class="modal-footer">
            <button type="button" class="text-sm sm:text-md bg-merah-tua hover:bg-merah-muda w-fit text-white p-3 rounded-lg flex items-center justify-center" data-bs-dismiss="modal">Tutup</button>
          </div>
        </div>
      </div>
    </div>`
      ...
      <div class="modal-dialog modal-lg modalCenter">
        <div class="modal-content">
          ...
          <div class="modal-body">
            <form>
              ...
              <div class="mb-3">
                ...
                <select name="emotion" id="emotion--${id.pk}" class="form-control block w-full px-3 py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none">
                  <option value="none" selected disabled hidden>Pilih Emosi</option>  
          ...
          <div class="modal-footer">
            ...
            <button id="simpan" type="button" class="text-sm sm:text-md bg-merah-tua hover:bg-merah-muda w-fit text-white p-3 rounded-lg flex items-center justify-center" onClick="editDiary(${id.pk})">Simpan</button>
          </div>
        </div>
      </div>
    </div>`
